...
export default function ModItem({ name, modPath, iconBase64, author }: Prop): JSX.Element {
    ...
    const [isOneshotMod, setIsOneshotMod] = useState(false);
    ...
    useEffect(() => {
        ...
        async function setup(): Promise<void> {
            ...
            setIsOneshotMod(await window.api.isFolderOneshotMod(modPath));
        }
    ...
    return (
        <div className={`mod-item ${isOneshotMod ? "" : "mod-item-invalid"}`}>
